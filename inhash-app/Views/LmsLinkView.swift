        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    NavigationLink(isActive: $showLoadingScreen) {
            ...
            .onChange(of: username) { _ in testConnected = false }
            .onChange(of: password) { _ in testConnected = false }
        }
        // 로딩 화면은 별도 화면(DataLoadingView)로 즉시 이동하므로 여기선 fullScreenCover 미사용
    }
